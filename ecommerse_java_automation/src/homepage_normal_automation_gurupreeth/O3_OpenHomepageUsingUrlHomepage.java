...
public class O3_OpenHomepageUsingUrlHomepage {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String websiteUrl = O3_ReadFromExcel.getData("Homepage", 1, 4);
            String expectedTitle = O3_ReadFromExcel.getData("Homepage", 1, 1);
            String expectedUrl = O3_ReadFromExcel.getData("Homepage", 1, 4);

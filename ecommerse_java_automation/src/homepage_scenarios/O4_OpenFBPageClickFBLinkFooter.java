...
public class O4_OpenFBPageClickFBLinkFooter implements AutomationConstants {
	public static void main(String[] args) {
		...
		try {
			...
			WebElement fbLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='https://www.facebook.com']")));
			fbLink.click();
